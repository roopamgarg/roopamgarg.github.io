      ...
      <div className="grid gap-6 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,0.8fr)]">
        <div className="card space-y-5">
            <div className="space-y-2">
              <h3 className="text-2xl font-black normal-case md:uppercase tracking-wide text-text">
                {contact.headline}
              </h3>
        ...
        <div className="card space-y-5">
          <div className="space-y-1">
            <div className="text-xs normal-case md:uppercase tracking-widest text-muted">
              Currently
            </div>
