        ...
        >
          ...
          <div className="min-w-0 space-y-1.5 border-l border-border/15 group-hover:border-accent/35 pl-4 md:pl-6 transition-colors duration-300 relative">
            ...
            <span
              ...
              aria-hidden="true"
            />
            <div className="text-sm font-black capitalize tracking-wider text-text transition-colors duration-300 group-hover:text-accent">{item.role}</div>
            <div className="text-xs font-bold capitalize tracking-wider text-accent/80 transition-colors duration-300 group-hover:text-accent">{item.company}</div>
