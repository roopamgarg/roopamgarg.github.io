  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 relative z-10">
        <div className="inline-flex max-w-fit items-center gap-2 rounded-full border border-accent/20 bg-accent/[0.03] px-3.5 py-1 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-accent select-none">
        ...
        <h1
          id="hero-heading"
          className="text-5xl font-black leading-[1.05] tracking-tight text-text sm:text-6xl md:text-7xl uppercase font-sans"
        >
          {hero.titleLead}{" "}
        ...
        <div className="mt-4 flex flex-wrap items-center gap-4">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-accent px-5 py-3 text-xs font-bold uppercase tracking-wider text-accent-fg transition-all hover:scale-[1.02]"
          >
            {hero.primaryCta}
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-border/10 bg-surface/30 px-5 py-3 text-xs font-bold uppercase tracking-wider text-text transition-all hover:bg-surface/50 hover:border-border/20 hover:scale-[1.02]"
          >
            {hero.secondaryCta}
