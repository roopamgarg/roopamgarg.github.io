      ...
      <div className="flex flex-col gap-6 relative z-10">
        ...
        >
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-accent px-5 py-3 text-xs font-bold capitalize tracking-wider text-accent-fg transition-all hover:scale-[1.02]"
          >
            {hero.primaryCta}
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-border/10 bg-surface/30 px-5 py-3 text-xs font-bold capitalize tracking-wider text-text transition-all hover:bg-surface/50 hover:border-border/20 hover:scale-[1.02]"
          >
            {hero.secondaryCta}
