  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-screen flex-col gap-8 px-3 py-6 sm:px-4 md:gap-10 md:px-6 md:py-8">
        <a
          href="#home"
          className="inline-flex items-center justify-center gap-2 text-lg font-black capitalize tracking-[0.15em] text-text md:justify-start"
        >
              ...
              return (
                <li key={item.id}>
                  <a
                    ...
                    className={[
                      "group flex items-center justify-center gap-3 rounded-lg px-2 py-2.5 text-xs font-bold capitalize tracking-wider transition-all duration-300 md:justify-start md:px-4 border-l-2",
                      isActive
