      ...
      <div className="flex items-center justify-between gap-4 px-4 py-4 md:px-8">
        <div className="flex items-center gap-3">
          ...
          <a
            href="#home"
            className={[
              "flex items-center gap-2 text-sm font-black normal-case md:uppercase tracking-[0.15em] text-text",
        ...
        <nav aria-label="Top">
          <ul className="flex items-center gap-2 text-xs font-bold normal-case md:uppercase tracking-wider">
